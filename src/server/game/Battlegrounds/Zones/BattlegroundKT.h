...
enum BG_KT_NPC
{
    BG_KT_MAX_TEAM_SCORE        = 1600,
    BG_KT_EVENT_START_BATTLE    = 8563,
    BG_KT_POINTS_UPDATE_TIME    = 8 * IN_MILLISECONDS,
    BG_KT_TIME_LIMIT            = 25 * MINUTE * IN_MILLISECONDS
};
...
{
    KT_EVENT_ORB                = 0,
    KT_EVENT_SPIRITGUIDES_SPAWN = 2 // Spirit guides will spawn at the same time as TP_EVENT_DOOR_OPEN.
};
