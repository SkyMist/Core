...
BattlegroundRV::BattlegroundRV()
{
    ...
    // Helper for checking player height.
    fencesOpened = false;
}
...
void BattlegroundRV::AddPlayer(Player* player)
{
    ...
    BattlegroundRVScore* sc = new BattlegroundRVScore; // Create score and add it to map, default values are set in constructor.
...
bool BattlegroundRV::SetupBattleground()
{
    ...
    {
        sLog->outError(LOG_FILTER_SQL, "BattlegroundRV: Failed to spawn some object!");
        return false;
    }
