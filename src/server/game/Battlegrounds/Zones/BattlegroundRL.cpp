...
void BattlegroundRL::AddPlayer(Player* player)
{
    ...
    BattlegroundRLScore* sc = new BattlegroundRLScore; // Create score and add it to map, default values are set in constructor.
...
bool BattlegroundRL::SetupBattleground()
{
    ...
    if (!AddObject(BG_RL_OBJECT_DOOR_1, BG_RL_OBJECT_TYPE_DOOR_1, 1293.561f, 1601.938f, 31.60557f, -1.457349f, 0, 0, -0.6658813f, 0.7460576f, RESPAWN_IMMEDIATELY)
     ...
     // Buffs.
     || !AddObject(BG_RL_OBJECT_BUFF_1, BG_RL_OBJECT_TYPE_BUFF_1, 1328.719971f, 1632.719971f, 36.730400f, -1.44862400f, 0, 0, 0.66262010f, -0.7489557f, 120)
