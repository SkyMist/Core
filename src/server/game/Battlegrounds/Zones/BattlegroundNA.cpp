...
void BattlegroundNA::AddPlayer(Player* player)
{
    ...
    BattlegroundNAScore* sc = new BattlegroundNAScore; // Create score and add it to map, default values are set in constructor.
...
bool BattlegroundNA::SetupBattleground()
{
    ...
    // Buffs.
     || !AddObject(BG_NA_OBJECT_BUFF_1, BG_NA_OBJECT_TYPE_BUFF_1, 4009.189941f, 2895.250000f, 13.052700f, -1.44862400f, 0, 0, 0.66262010f, -0.7489557f, 120)
