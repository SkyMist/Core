...
namespace Movement
{
    ...
    void MoveSplineInit::Launch()
    {
        ...
        // Need to compute current position for unfinalized states.
        ...
        if (!args.HasVelocity)
        {
            // If spline is initialized with SetWalk method it only means we need to select walk move speed for it but not add walk flag to unit.
