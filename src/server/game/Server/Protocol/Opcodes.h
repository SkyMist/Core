...
enum Opcodes
{
    ...
    CMSG_ADD_VOICE_IGNORE                             = 0x0000, // 5.4.7 18019
    ...
    CMSG_BATTLEFIELD_LEAVE                            = 0x0000, // CHECK!
    ...
    CMSG_BATTLEFIELD_PORT                             = 0x0000, // CHECK!
    ...
    CMSG_LEAVE_BATTLEFIELD                            = 0x045F, // CHECK!
    CMSG_LEAVE_BATTLEFIELD_AT_END                     = 0x1C5B, // CHECK!
    ...
    CMSG_BEGIN_TRADE                                  = 0x1D52, // CHECK!
    CMSG_BINDER_ACTIVATE                              = 0x0477, // 5.4.7 18019
    CMSG_BUG                                          = 0x139B, // 5.4.7 18019
    ...
    CMSG_CALENDAR_REMOVE_EVENT                        = 0x1DA1, // 5.4.7 18019
    ...
    CMSG_COMMENTATOR_ENABLE                           = 0x0000, // Seems like 0x169A - CHECK!
    ...
    CMSG_CONNECT_TO_FAILED                            = 0x0000, // Seems like 0x16C8 - CHECK!
    ...
    CMSG_DISMISS_CRITTER                              = 0x0000, // 5.4.7 18019
    CMSG_DUEL_PROPOSED                                = 0x19B3, // 5.4.7 18019
    // CMSG_DUEL_RESPONSE                                = 0x07FC, // 5.4.7 18019 - CHECK!
    ...
    CMSG_GROUP_SWAP_SUB_GROUP                         = 0x1D80, // 5.4.7 18019
    ...
    CMSG_GUILD_BANK_MONEY_WITHDRAWN_QUERY             = 0x1BB7, // Or 0x03FC - CHECK!
    ...
    CMSG_LF_GUILD_GET_APPLICATIONS                    = 0x0000, // Maybe 0x0198C - CHECK!
    ...
    CMSG_QUERY_BATTLEFIELD_STATE                      = 0x1D33, // 5.4.7 18019
    ...
    CMSG_REDIRECTION_AUTH_PROOF                       = 0x1A5B, // 5.4.7 18019
    ...
    CMSG_REQUEST_INSPECT_RATED_BG_STATS               = 0x0000, // 0x1CB3 - CHECK!
    ...
    CMSG_RESET_FACTION_CHEAT                          = 0x0000, // 0x1B5A - CHECK!
    ...
    CMSG_SAVE_CUF_PROFILES                            = 0x0C88, // Or 0x3208 - CHECK!
    CMSG_SELF_RES                                     = 0x10F4, // 5.4.7 18019
    CMSG_SELL_ITEM                                    = 0x115F, // 5.4.7 18019
    CMSG_SEND_MAIL                                    = 0x01A9, // 5.4.7 18019
    CMSG_SEND_SOR_REQUEST_VIA_ADDRESS                 = 0x0000, // 5.4.7 18019
    CMSG_SEND_SOR_REQUEST_VIA_BNET_ACCOUNT_ID         = 0x0000, // 5.4.7 18019
    ...
    CMSG_MOVE_SET_RUN_MODE                            = 0x0878, // 5.4.7 18019
    CMSG_MOVE_SET_WALK_MODE                           = 0x0138, // 5.4.7 18019
    ...
    // SMSG_ATTACKSWING_RESULT                           = 0x04E0, // 5.4.7 18019 - CHECK!
    ...
    SMSG_BATTLEFIELD_LIST                             = 0x1408, // 5.4.7 18019
    ...
    SMSG_BATTLEFIELD_STATUS_NEED_CONFIRMATION         = 0x147A, // 5.4.7 18019
    SMSG_BATTLEFIELD_STATUS_WAIT_FOR_GROUPS           = 0x1701, // 5.4.7 18019
    SMSG_BATTLEGROUND_INFO_THROTTLED                  = 0x0000, // 5.4.7 18019
    ...
    SMSG_CALENDAR_SEND_EVENT                          = 0x05E0, // 5.4.7 18019
    ...
    SMSG_DEFENSE_MESSAGE                              = 0x0000, // 0x01E8, // 5.4.7 18019 - CHECK!
    ...
    SMSG_INSPECT_HONOR_STATS = 0x0000, // 0x1429 - CHECK!
