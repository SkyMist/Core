...
enum Opcodes
{
   ...
   CMSG_ACCEPT_TRADE                                        = 0x1E73, // 5.4.7 18019 NYI
   ...
   CMSG_AUCTION_LIST_BIDDER_ITEMS                           = 0x04D6, // 5.4.7 18019 NYI
   CMSG_AUCTION_LIST_ITEMS                                  = 0x105F, // 5.4.7 18019 NYI
   CMSG_AUCTION_LIST_OWNER_ITEMS                            = 0x105E, // 5.4.7 18019 NYI
   CMSG_AUCTION_LIST_PENDING_SALES                          = 0x1055, // 5.4.7 18019 NYI
   CMSG_AUCTION_PLACE_BID                                   = 0x10F5, // 5.4.7 18019 NYI
   CMSG_AUCTION_REMOVE_ITEM                                 = 0x0754, // 5.4.7 18019 NYI
   CMSG_AUCTION_SELL_ITEM                                   = 0x07F5, // 5.4.7 18019 NYI
   ...
   CMSG_BATTLEFIELD_LEAVE                                   = 0x1C5B, // 5.4.7 18019
   ...
   CMSG_BATTLEFIELD_PORT                                    = 0x045F, // 5.4.7 18019
   ...
   CMSG_BLACK_MARKET_LIST                                   = 0x06D4, // 5.4.7 18019 NYI
   CMSG_BLACK_MARKET_PLACE_BID                              = 0x03FE, // 5.4.7 18019 NYI
   CMSG_BOT_DETECTED2                                       = 0x0,
   CMSG_BUG                                                 = 0x139B, // 5.4.7 18019 NYI
   CMSG_BUSY_TRADE                                          = 0x0,
   ...
   CMSG_CHANNEL_OWNER                                       = 0x1508, // 5.4.7 18019 NYI
   ...
   CMSG_CHAT_IGNORED                                        = 0x0720, // 5.4.7 18019 NYI
   ...
   CMSG_COMPLAIN                                            = 0x1791, // 5.4.7 18019 NYI
   ...
   CMSG_FORCE_MOVE_ROOT_ACK                                 = 0x0118, // 5.4.7 18019 NYI
   CMSG_FORCE_MOVE_UNROOT_ACK                               = 0x0458, // 5.4.7 18019 NYI
   ...
   CMSG_GROUP_ASSISTANT_LEADER                              = 0x0DBB, // 5.4.7 18019 NYI
   CMSG_GROUP_CANCEL                                        = 0x0,
   CMSG_GROUP_CHANGE_SUB_GROUP                              = 0x17D9, // 5.4.7 18019 NYI
   ...
   CMSG_GROUP_SWAP_SUB_GROUP                                = 0x1D80, // 5.4.7 18019 NYI
   ...
   CMSG_GUILD_BANK_SWAP_ITEMS                               = 0x02DF, // 5.4.7 18019 NYI
   ...
   CMSG_LF_GUILD_GET_RECRUITS                               = 0x198C, // 5.4.7 18019 NYI
   CMSG_LF_GUILD_POST_REQUEST                               = 0x1B3E, // 5.4.7 18019 NYI
   CMSG_LF_GUILD_REMOVE_RECRUIT                             = 0x0,
   CMSG_LF_GUILD_SET_GUILD_POST                             = 0x13C2, // 5.4.7 18019 NYI
   ...
   CMSG_LOOT_ROLL                                           = 0x1F53, // 5.4.7 18019 NYI
   ...
   CMSG_MOVE_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK             = 0x095A, // 5.4.7 18019 NYI
   CMSG_MOVE_FORCE_FLIGHT_SPEED_CHANGE_ACK                  = 0x0839, // 5.4.7 18019 NYI
   CMSG_MOVE_FORCE_PITCH_RATE_CHANGE_ACK                    = 0x0,
   CMSG_MOVE_FORCE_RUN_BACK_SPEED_CHANGE_ACK                = 0x0512, // 5.4.7 18019 NYI
   CMSG_MOVE_FORCE_RUN_SPEED_CHANGE_ACK                     = 0x0018, // 5.4.7 18019 NYI
   CMSG_MOVE_FORCE_SWIM_BACK_SPEED_CHANGE_ACK               = 0x0070, // 5.4.7 18019 NYI
   CMSG_MOVE_FORCE_SWIM_SPEED_CHANGE_ACK                    = 0x0811, // 5.4.7 18019 NYI
   CMSG_MOVE_FORCE_TURN_RATE_CHANGE_ACK                     = 0x0,
   CMSG_MOVE_FORCE_WALK_SPEED_CHANGE_ACK                    = 0x0831, // 5.4.7 18019 NYI
   CMSG_MOVE_GRAVITY_DISABLE_ACK                            = 0x0,
   CMSG_MOVE_GRAVITY_ENABLE_ACK                             = 0x0,
   CMSG_MOVE_HOVER_ACK                                      = 0x0,
   CMSG_MOVE_KNOCK_BACK_ACK                                 = 0x053A, // 5.4.7 18019 NYI
   CMSG_MOVE_NOT_ACTIVE_MOVER                               = 0x0,
   CMSG_MOVE_SET_CAN_FLY                                    = 0x0,
   CMSG_MOVE_SET_CAN_FLY_ACK                                = 0x0952, // 5.4.7 18019 NYI
   ...
   CMSG_OFFER_PETITION                                      = 0x1992, // 5.4.7 18019 NYI
   ...
   CMSG_PETITION_BUY                                        = 0x07D6, // 5.4.7 18019 NYI
   CMSG_PETITION_QUERY                                      = 0x15A2, // 5.4.7 18019 NYI
   CMSG_PETITION_SHOWLIST                                   = 0x0,
   CMSG_PETITION_SHOW_SIGNATURES                            = 0x11FC, // 5.4.7 18019 NYI
   CMSG_PETITION_SIGN                                       = 0x0555, // 5.4.7 18019 NYI
   CMSG_PET_ABANDON                                         = 0x05D7, // 5.4.7 18019
   CMSG_PET_ACTION                                          = 0x04D4, // 5.4.7 18019
   CMSG_PET_BATTLE_QUEUE_JOIN                               = 0x13B0, // 5.4.7 18019 NYI
   ...
   CMSG_QUERY_BATTLEFIELD_STATE                             = 0x1D33, // 5.4.7 18019 NYI
   CMSG_QUERY_GUILD_MEMBERS_FOR_RECIPE                      = 0x0,
   CMSG_QUERY_GUILD_MEMBER_RECIPES                          = 0x0,
   CMSG_QUERY_GUILD_RECIPES                                 = 0x1DBC, // 5.4.7 18019 NYI
   ...
   CMSG_REQUEST_ACCOUNT_DATA                                = 0x1410, // 5.4.7 18019 NYI
   CMSG_REQUEST_BATTLEPET_JOURNAL                           = 0x12C1, // 5.4.7 18019 NYI
   ...
   CMSG_RESET_FACTION_CHEAT                                 = 0x1B5A, // 5.4.7 18019
   ...
   CMSG_ROLE_POLL_BEGIN                                     = 0x0D90, // 5.4.7 18019 NYI
   CMSG_SAVE_CUF_PROFILES                                   = 0x3208, // 5.4.7 18019
   ...
   CMSG_SET_EVERYONE_IS_ASSISTANT                           = 0x1C81, // 5.4.7 18019 NYI
   ...
   CMSG_TURN_IN_PETITION                                    = 0x04F7, // 5.4.7 18019 NYI
   ...
   MSG_SAVE_GUILD_EMBLEM                                    = 0x04E8, // 5.4.7 18019 NYI
   MSG_START_MOVE_FORWARD                                   = 0x0,
   MSG_TABARDVENDOR_ACTIVATE                                = 0x12B8, // 5.4.7 18019 NYI
   MSG_TALENT_WIPE_CONFIRM                                  = 0x0,
   MSG_VERIFY_CONNECTIVITY                                  = 0x4F57, // 5.4.7 18019 - Constant Opcode - Never changes.
   ...
   SMSG_ACTIVATETAXIREPLY                                   = 0x1D72, // 5.4.7 18019
   ...
   SMSG_AUCTION_BIDDER_NOTIFICATION                         = 0x11E8, // 5.4.7 18019 NYI
   ...
   SMSG_AURA_POINTS_DEPLETED                                = 0x0151, // 5.4.7 18019 NYI
   ...
   SMSG_BATTLE_PET_CAGE_DATA_ERROR                          = 0x14A1, // 5.4.7 18019 NYI
   SMSG_BATTLE_PET_DELETED                                  = 0x13F1, // 5.4.7 18019 NYI
   SMSG_BATTLE_PET_ERROR                                    = 0x1C12, // 5.4.7 18019 NYI
   SMSG_BATTLE_PET_HEALED                                   = 0x0,
   SMSG_BATTLE_PET_JOURNAL                                  = 0x14A0, // 5.4.7 18019 NYI
   ...
   SMSG_BLACK_MARKET_HELLO                                  = 0x15E2, // 5.4.7 18019 NYI
   SMSG_BLACK_MARKET_LIST                                   = 0x165A, // 5.4.7 18019 NYI
   SMSG_BLACKMARKET_OUT_BID                                 = 0x12A3, // 5.4.7 18019 NYI
   SMSG_BLACKMARKET_BID_ON_ITEM_RESULT                      = 0x064B, // 5.4.7 18019 NYI
   SMSG_BLACKMARKET_WON                                     = 0x04A9, // 5.4.7 18019 NYI
   ...
   SMSG_CALENDAR_SEND_EVENT                                 = 0x05E0, // 5.4.7 18019 NYI
   ...
   SMSG_CHANNEL_START                                       = 0x1B15, // 5.4.7 18019
   SMSG_CHANNEL_UPDATE                                      = 0x087B, // 5.4.7 18019
   ...
   SMSG_DGN_CHALLENGE_MODE_DELETE_LEADER_RESULT             = 0x05A2, // 5.4.7 18019 NYI
   SMSG_DGN_CHALLENGE_MODE_ALL_MAP_STATS                    = 0x1621, // 5.4.7 18019 NYI
   SMSG_DGN_CHALLENGE_MODE_REQ_LEADERS_RESULT               = 0x0668, // 5.4.7 18019 NYI
   SMSG_DGN_CHALLENGE_MODE_REWARDS                          = 0x1413, // 5.4.7 18019 NYI
   SMSG_DGN_CHALLENGE_MODE_NEW_PLAYER_RECORD                = 0x0C80, // 5.4.7 18019 NYI
   SMSG_DGN_CHALLENGE_MODE_COMPLETE                         = 0x1D53, // 5.4.7 18019 NYI
   ...
   SMSG_DUEL_OUTOFBOUNDS                                    = 0x0461, // 5.4.7 18019 NYI
   ...
   SMSG_ENVIRONMENTALDAMAGELOG                              = 0x0032, // 5.4.7 18019 NYI
   ...
   SMSG_FLIGHT_SPLINE_SYNC                                  = 0x0992, // 5.4.7 18019 NYI
   ...
   SMSG_GAMESPEED_SET                                       = 0x1D73, // 5.4.7 18019 NYI
   ...
   SMSG_GAMETIME_SET                                        = 0x037E, // 5.4.7 18019 NYI
   SMSG_GAMETIME_UPDATE                                     = 0x00A3, // 5.4.7 18019 NYI
   ...
   SMSG_GMTICKET_GETTICKET                                  = 0x054B, // 5.4.7 18019 NYI
   SMSG_GMTICKET_SYSTEMSTATUS                               = 0x145B, // 5.4.7 18019
   ...
   SMSG_GUILD_ACHIEVEMENT_DATA                              = 0x1B5A, // 5.4.7 18019 NYI
   ...
   SMSG_GUILD_CRITERIA_DATA                                 = 0x12F9, // 5.4.7 18019 NYI
   ...
   SMSG_ITEM_ENCHANT_TIME_UPDATE                            = 0x0660, // 5.4.7 18019 NYI
   ...
   SMSG_LFG_PLAYER_INFO                                     = 0x13B0, // 5.4.7 18019 NYI
   ...
   SMSG_LFG_UPDATE_STATUS                                   = 0x1661, // 5.4.7 18019 NYI
   ...
   SMSG_LOAD_CUF_PROFILES                                   = 0x5545, // 5.4.7 18019
   ...
   SMSG_LOOT_LIST                                           = 0x0,
   SMSG_LOOT_MASTER_LIST                                    = 0x1D5B, // 5.4.7 18019 NYI
   ...
   SMSG_LOOT_ROLL                                           = 0x1473, // 5.4.7 18019 NYI
   ...
   SMSG_MIRRORIMAGE_DATA                                    = 0x1917, // 5.4.7 18019 NYI
   ...
   SMSG_MOUNTSPECIAL_ANIM                                   = 0x0E4B, // 5.4.7 18019
   ...
   SMSG_PARTYKILLLOG                                        = 0x0F23, // 5.4.7 18019 NYI
   SMSG_PARTY_COMMAND_RESULT                                = 0x1787, // 5.4.7 18019
   SMSG_PARTY_MEMBER_STATS                                  = 0x0E61, // 5.4.7 18019 NYI
   SMSG_PARTY_MEMBER_STATS_FULL                             = 0x0,
   SMSG_PAUSE_MIRROR_TIMER                                  = 0x1C7B, // 5.4.7 18019 NYI
   SMSG_PERIODICAURALOG                                     = 0x051B, // 5.4.7 18019
   SMSG_PETGODMODE                                          = 0x0,
   SMSG_PETITION_ALREADY_SIGNED                             = 0x1409, // 5.4.7 18019 NYI
   SMSG_PETITION_QUERY_RESPONSE                             = 0x1732, // 5.4.7 18019 NYI
   SMSG_PETITION_SHOWLIST                                   = 0x1C32, // 5.4.7 18019 NYI
   SMSG_PETITION_SHOW_SIGNATURES                            = 0x0899, // 5.4.7 18019 NYI
   SMSG_PETITION_SIGN_RESULTS                               = 0x1E69, // 5.4.7 18019 NYI
   SMSG_PET_ACTION_FEEDBACK                                 = 0x0,
   SMSG_PET_ACTION_SOUND                                    = 0x0,
   SMSG_PET_ADDED                                           = 0x0,
   SMSG_PET_BATTLE_CHAT_RESTRICTED                          = 0x1F53, // 5.4.7 18019 NYI
   SMSG_PET_BATTLE_DEBUG_QUEUE_DUMP_RESPONSE                = 0x13E9, // 5.4.7 18019 NYI
   SMSG_PET_BATTLE_FULL_UPDATE                              = 0x01E3, // 5.4.7 18019 NYI
   SMSG_PET_BATTLE_FINAL_ROUND                              = 0x12F0, // 5.4.7 18019 NYI
   SMSG_PET_BATTLE_FINISHED                                 = 0x1E33, // 5.4.7 18019 NYI
   SMSG_PET_BATTLE_FIRST_ROUND                              = 0x1612, // 5.4.7 18019 NYI
   SMSG_PET_BATTLE_MAX_GAME_LENGTH_WARNING                  = 0x12BB, // 5.4.7 18019 NYI
   SMSG_PET_BATTLE_PVP_CHALLENGE                            = 0x1C08, // 5.4.7 18019 NYI
   SMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH                      = 0x0E62, // 5.4.7 18019 NYI
   SMSG_PET_BATTLE_QUEUE_STATUS                             = 0x1540, // 5.4.7 18019 NYI
   SMSG_PET_BATTLE_ROUND_RESULT                             = 0x0709, // 5.4.7 18019 NYI
   SMSG_PET_BATTLE_REPLACEMENTS_MADE                        = 0x0891, // 5.4.7 18019 NYI
   SMSG_PET_BATTLE_SLOT_UPDATE                              = 0x0421, // 5.4.7 18019 NYI
   SMSG_PET_BROKEN                                          = 0x0,
   SMSG_PET_CAST_FAILED                                     = 0x1D33, // 5.4.7 18019 NYI
   ...
   SMSG_PRE_RESURRECT                                       = 0x1F52, // 5.4.7 18019 NYI
   SMSG_PROCRESIST                                          = 0x0,
   ...
   SMSG_ROLE_POLL_BEGIN                                     = 0x1F61, // 5.4.7 18019 NYI
   SMSG_RWHOIS                                              = 0x0,
   SMSG_SCENARIO_POI                                        = 0x10E9, // 5.4.7 18019 NYI
   ...
   SMSG_SHOP_ITEM                                           = 0x0,
   SMSG_SHOWTAXINODES                                       = 0x14A3, // 5.4.7 18019
   ...
   SMSG_SPELLDISPELLOG                                      = 0x0919, // 5.4.7 18019 NYI
   SMSG_SPELLENERGIZELOG                                    = 0x0071, // 5.4.7 18019 NYI
   SMSG_SPELLHEALLOG                                        = 0x1BBF, // 5.4.7 18019
   SMSG_SPELLINSTAKILLLOG                                   = 0x0D7A, // 5.4.7 18019 NYI
   SMSG_SPELLINTERRUPTLOG                                   = 0x091A, // 5.4.7 18019 NYI
   ...
   SMSG_START_MIRROR_TIMER                                  = 0x0D48, // 5.4.7 18019 NYI
   SMSG_START_TIMER                                         = 0x0,
   SMSG_STOP_DANCE                                          = 0x0,
   SMSG_STOP_MIRROR_TIMER                                   = 0x1E01, // 5.4.7 18019 NYI
   ...
   SMSG_SUSPEND_COMMS                                       = 0x10B0, // 5.4.7 18019 NYI
   ...
   SMSG_TAXINODE_STATUS                                     = 0x0E23, // 5.4.7 18019
   ...
   SMSG_UPDATE_ACCOUNT_DATA                                 = 0x13B9, // 5.4.7 18019 NYI
   ...
   SMSG_WEEKLY_SPELL_USAGE                                  = 0x1D04, // 5.4.7 18019 NYI
