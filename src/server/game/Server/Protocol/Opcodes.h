...
enum Opcodes
{
   ...
   CMSG_BATTLEFIELD_LIST                                    = 0x1412, // 5.4.7 18019 NYI
   ...
   CMSG_BATTLEMASTER_JOIN                                   = 0x06DD, // 5.4.7 18019 NYI
   ...
   CMSG_EQUIPMENT_SET_DELETE                                = 0x01DC, // 5.4.7 18019 NYI
   CMSG_EQUIPMENT_SET_SAVE                                  = 0x115C, // 5.4.7 18019 NYI
   CMSG_EQUIPMENT_SET_USE                                   = 0x1402, // 5.4.7 18019 NYI
   ...
   CMSG_GUILD_REQUEST_PARTY_STATE                           = 0x14A8, // 5.4.7 18019 NYI
   ...
   CMSG_REQUEST_CEMETERY_LIST                               = 0x14A9, // 5.4.7 18019 NYI
   ...
   CMSG_VOID_STORAGE_QUERY                                  = 0x01E1, // 5.4.7 18019 NYI
   CMSG_VOID_STORAGE_TRANSFER                               = 0x1F73, // 5.4.7 18019 NYI
   CMSG_VOID_STORAGE_UNLOCK                                 = 0x13F2, // 5.4.7 18019 NYI
   ...
   SMSG_BATTLEFIELD_LIST                                    = 0x1408, // 5.4.7 18019 NYI
   ...
   SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE              = 0x1E40, // 5.4.7 18019 NYI
   ...
   SMSG_EQUIPMENT_SET_LIST                                  = 0x11E9, // 5.4.7 18019 NYI
   ...
   SMSG_GUILD_PARTY_STATE_RESPONSE                          = 0x1A52, // 5.4.7 18019 NYI
   ...
   SMSG_PVP_CREDIT                                          = 0x0,
   SMSG_PVP_LOG_DATA                                        = 0x076A, // 5.4.7 18019 NYI
   ...
   SMSG_SPLINE_MOVE_SET_RUN_BACK_SPEED                      = 0x09B8, // 5.4.7 18019 NYI
   SMSG_SPLINE_MOVE_SET_RUN_MODE                            = 0x0,
   SMSG_SPLINE_MOVE_SET_RUN_SPEED                           = 0x1A90, // 5.4.7 18019 NYI
   SMSG_SPLINE_MOVE_SET_SWIM_BACK_SPEED                     = 0x0,
   SMSG_SPLINE_MOVE_SET_SWIM_SPEED                          = 0x0254, // 5.4.7 18019 NYI
   SMSG_SPLINE_MOVE_SET_TURN_RATE                           = 0x0,
   SMSG_SPLINE_MOVE_SET_WALK_MODE                           = 0x0,
   SMSG_SPLINE_MOVE_SET_WALK_SPEED                          = 0x0155, // 5.4.7 18019 NYI
   SMSG_SPLINE_MOVE_SET_WATER_WALK                          = 0x0,
   SMSG_SPLINE_MOVE_START_SWIM                              = 0x0,
   SMSG_SPLINE_MOVE_STOP_SWIM                               = 0x0,
   SMSG_SPLINE_MOVE_UNROOT                                  = 0x1698, // 5.4.7 18019 NYI
   ...
   SMSG_TRADE_STATUS                                        = 0x0609, // 5.4.7 18019 NYI
   ...
   SMSG_VOID_ITEM_SWAP_RESPONSE                             = 0x0E2B, // 5.4.7 18019 NYI
   SMSG_VOID_STORAGE_CONTENTS                               = 0x0C93, // 5.4.7 18019 NYI
   SMSG_VOID_STORAGE_FAILED                                 = 0x1569, // 5.4.7 18019 NYI
   SMSG_VOID_STORAGE_TRANSFER_CHANGES                       = 0x05A8, // 5.4.7 18019 NYI
   SMSG_VOID_TRANSFER_RESULT                                = 0x00E3, // 5.4.7 18019 NYI
