...
class ChatHandler
{
    public:
        ...
        static void FillMessageData(WorldPacket* data, WorldSession* session, uint8 type, uint32 language, const char* channelName, uint64 target_guid, const char* message, Unit* speaker, const char* addonPrefix = NULL, uint8 chatTag = CHAT_TAG_NONE, uint32 achievementId = 0, char const* localizedName = NULL);
