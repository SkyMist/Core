...
char const Achievementfmt[] = "niiissiiiiisiix";
//const std::string CustomAchievementfmt = "pppaaaapapaappa";
//const std::string CustomAchievementIndex = "ID";
char const AchievementCategoryfmt[] = "nisi";
char const AchievementCriteriafmt[] = "niiiixiiiisiiiiixxiiiii";
char const AreaTableEntryfmt[] = "iiinixiiisiiisiiiiiffixxxxxxxx";
char const AreaGroupEntryfmt[] = "niiiiiii";
char const AreaPOIEntryfmt[] = "niiiiiiiiiiiffixissixxx";
...
char const BannedAddOnsfmt[] = "niiiiiiiiii";
char const BarberShopStyleEntryfmt[] = "nisifiii";
char const BattlemasterListEntryfmt[] = "niiiiiiiiiiiiiiiiixsiiiiiiiixx";
...
char const ChatChannelsEntryfmt[] = "niiss";
...
char const ItemBagFamilyfmt[] = "ns";
...
char const ItemLimitCategoryEntryfmt[] = "nsii";
char const ItemRandomPropertiesfmt[] = "nsiiixxs";
char const ItemRandomSuffixfmt[] = "nssiiiiiiiiii";
...
char const OverrideSpellDatafmt[] = "niiiiiixxxxxx";
char const QuestFactionRewardfmt[] = "niiiiiiiiii";
char const QuestPOIBlobfmt[]="niii";
char const QuestPOIPointfmt[]="niii";
char const QuestSortEntryfmt[] = "ns";
...
char const SpellMiscfmt[] = "niiiiiiiiiiiiiiiiiifiiiii";
char const SpellEffectScalingfmt[] = "xfffxn";
...
char const SpellPowerEntryfmt[] = "niiiiiiiiffif";
char const SpellInterruptsEntryfmt[] = "diiixixi";
...
char const TotemCategoryEntryfmt[] = "nsii";
...
char const VehicleSeatEntryfmt[] = "niiffffffffffiiiiiifffffffiiifffiiiiiiiffiiiixxxxxxxxxxxxxxxxxxxxi";
