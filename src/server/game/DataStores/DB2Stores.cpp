...
DB2Storage <SceneScriptEntry> sSceneScriptStore(SceneScriptStoreEntryfmt);
DB2Storage <SceneScriptPackageEntry> sSceneScriptPackageStore(SceneScriptPackageStoreEntryfmt);
