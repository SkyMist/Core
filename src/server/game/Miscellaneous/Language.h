...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    // Battle For Gilneas
    LANG_BG_BG_START_TWO_MINUTES            = 12015,
    LANG_BG_BG_START_ONE_MINUTE             = 12016,
    LANG_BG_BG_START_HALF_MINUTE            = 12017,
    LANG_BG_BG_HAS_BEGUN                    = 12018,
    LANG_BG_BG_ALLY                         = 12019,
    LANG_BG_BG_HORDE                        = 12020,
    LANG_BG_BG_NODE_LIGHTHOUSE              = 12021,
    LANG_BG_BG_NODE_WATERWORKS              = 12022,
    LANG_BG_BG_NODE_MINE                    = 12023,
    LANG_BG_BG_NODE_TAKEN                   = 12024,
    LANG_BG_BG_NODE_DEFENDED                = 12025,
    LANG_BG_BG_NODE_ASSAULTED               = 12026,
    LANG_BG_BG_NODE_CLAIMED                 = 12027,
    LANG_BG_BG_A_NEAR_VICTORY               = 12028,
    LANG_BG_BG_H_NEAR_VICTORY               = 12029,

    // Temple of Kotmogu
    LANG_BG_TK_START_TWO_MINUTES            = 12030,
    LANG_BG_TK_START_ONE_MINUTE             = 12031,
    LANG_BG_TK_START_HALF_MINUTE            = 12032,
    LANG_BG_TK_HAS_BEGUN                    = 12033,
    LANG_BG_TK_ORB_PICKED_UP                = 12034,
    LANG_BG_TK_ORB_DROPPED                  = 12035,

    // CTF3
    LANG_BG_CTF_START_TWO_MINUTES           = 12036,
    LANG_BG_CTF_START_ONE_MINUTE            = 12037,
    LANG_BG_CTF_START_HALF_MINUTE           = 12038,
    LANG_BG_CTF_HAS_BEGUN                   = 12039,
    LANG_BG_CTF_CAPTURED_HF                 = 12040,
    LANG_BG_CTF_CAPTURED_AF                 = 12041,
    LANG_BG_CTF_DROPPED_HF                  = 12042,
    LANG_BG_CTF_DROPPED_AF                  = 12043,
    LANG_BG_CTF_RETURNED_AF                 = 12044,
    LANG_BG_CTF_RETURNED_HF                 = 12045,
    LANG_BG_CTF_PICKEDUP_HF                 = 12046,
    LANG_BG_CTF_PICKEDUP_AF                 = 12047,
    LANG_BG_CTF_F_PLACED                    = 12048,
    LANG_BG_CTF_ALLIANCE_FLAG_RESPAWNED     = 12049,
    LANG_BG_CTF_HORDE_FLAG_RESPAWNED        = 12050,

    // Deepwind Gorge
    LANG_BG_DG_START_TWO_MINUTES            = 12051,
    LANG_BG_DG_START_ONE_MINUTE             = 12052,
    LANG_BG_DG_START_HALF_MINUTE            = 12053,
    LANG_BG_DG_HAS_BEGUN                    = 12054,
    LANG_BG_DG_ALLY                         = 12055,
    LANG_BG_DG_HORDE                        = 12056,
    LANG_BG_DG_NODE_CENTER_MINE             = 12057,
    LANG_BG_DG_NODE_GOBLIN_MINE             = 12058,
    LANG_BG_DG_NODE_PANDAREN_MINE           = 12059,
    LANG_BG_DG_A_NEAR_VICTORY               = 12060,
    LANG_BG_DG_H_NEAR_VICTORY               = 12061,
    LANG_BG_DG_NODE_CLAIMED                 = 12062,
    LANG_BG_DG_NODE_ASSAULTED               = 12063,
    LANG_BG_DG_NODE_DEFENDED                = 12064,
    LANG_BG_DG_NODE_TAKEN                   = 12065,
