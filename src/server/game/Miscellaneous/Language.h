...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    // Silvershard Mines
    LANG_BG_SSM_START_TWO_MINUTES           = 12073,
    LANG_BG_SSM_START_ONE_MINUTE            = 12074,
    LANG_BG_SSM_START_HALF_MINUTE           = 12075,
    LANG_BG_SSM_HAS_BEGUN                   = 12076,
    LANG_BG_SSM_CART_CAPTURED               = 12077,
    LANG_BG_SSM_CART_DROPPED                = 12078,
    LANG_BG_SSM_CART_REACHED_SAFE           = 12079,

    // Deepwind Gorge
    LANG_BG_DG_START_TWO_MINUTES            = 12080,
    LANG_BG_DG_START_ONE_MINUTE             = 12081,
    LANG_BG_DG_START_HALF_MINUTE            = 12082,
    LANG_BG_DG_HAS_BEGUN                    = 12083,
    LANG_BG_DG_ALLY                         = 12084,
    LANG_BG_DG_HORDE                        = 12085,
    LANG_BG_DG_NODE_CENTER_MINE             = 12086,
    LANG_BG_DG_NODE_GOBLIN_MINE             = 12087,
    LANG_BG_DG_NODE_PANDAREN_MINE           = 12088,
    LANG_BG_DG_A_NEAR_VICTORY               = 12089,
    LANG_BG_DG_H_NEAR_VICTORY               = 12090,
    LANG_BG_DG_NODE_CLAIMED                 = 12091,
    LANG_BG_DG_NODE_ASSAULTED               = 12092,
    LANG_BG_DG_NODE_DEFENDED                = 12093,
    LANG_BG_DG_NODE_TAKEN                   = 12094,
    LANG_BG_DG_HAS_TAKEN_CART               = 12095,
    LANG_BG_DG_CART_DROPPED                 = 12096,
    LANG_BG_DG_CART_CAPTURED_A              = 12097,
    LANG_BG_DG_CART_CAPTURED_H              = 12098
