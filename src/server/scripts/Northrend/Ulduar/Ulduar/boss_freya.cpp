                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_NATURE_BOMB:
                        {
                            ...
                            SkyMistCore::AnyPlayerInObjectRangeCheck checker(me, 50.0f);
                            SkyMistCore::PlayerListSearcher<SkyMistCore::AnyPlayerInObjectRangeCheck> searcher(me, PlayerList, checker);
