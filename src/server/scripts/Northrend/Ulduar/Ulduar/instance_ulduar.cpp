...
class instance_ulduar : public InstanceMapScript
{
    public:
        ...
        struct instance_ulduar_InstanceMapScript : public InstanceScript
        {
            ...
            {
                data << uint32(WORLD_STATE_ALGALON_TIMER_ENABLED) << uint32(_algalonTimer && _algalonTimer <= 60);
                data << uint32(WORLD_STATE_ALGALON_DESPAWN_TIMER) << uint32(std::min<uint32>(_algalonTimer, 60));
            }
