        ...
        struct npc_crok_scourgebaneAI : public npc_escortAI
        {
            ...
            void WaypointStart(uint32 waypointId)
            {
                ...
                switch (waypointId)
                {
                    ...
                    case 4:
                    {
                        ...
                        SkyMistCore::CreatureListSearcher<FrostwingVrykulSearcher> searcher(me, temp, check);
            ...
            void DamageTaken(Unit* /*attacker*/, uint32& damage)
            {
                ...
                if (!_wipeCheckTimer)
                {
                    _wipeCheckTimer = 1000;
                    Player* player = NULL;
                    SkyMistCore::AnyPlayerInObjectRangeCheck check(me, 60.0f);
                    SkyMistCore::PlayerSearcher<SkyMistCore::AnyPlayerInObjectRangeCheck> searcher(me, player, check);
                    ...
                    if (!player)
                    {
                        ...
                        if (damage >= me->GetHealth())
                        {
                            ...
                            SkyMistCore::CreatureWorker<FrostwingGauntletRespawner> worker(me, respawner);
    ...
    public:
                ...
                while (uint32 eventId = Events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_ARNATH_PW_SHIELD:
                        {
                            ...
                            DoCast(SkyMistCore::Containers::SelectRandomContainerElement(targets), SPELL_POWER_WORD_SHIELD);
        ...
        private:
            Creature* FindFriendlyCreature() const
            {
                ...
                SkyMistCore::MostHPMissingInRange u_check(me, 60.0f, 0);
                SkyMistCore::CreatureLastSearcher<SkyMistCore::MostHPMissingInRange> searcher(me, target, u_check);
    ...
    public:
        ...
        class spell_icc_sprit_alarm_SpellScript : public SpellScript
        {
            ...
            void HandleEvent(SpellEffIndex effIndex)
            {
                ...
                wards.sort(SkyMistCore::ObjectDistanceOrderPred(GetCaster()));
    ...
    public:
        ...
        class spell_svalna_revive_champion_SpellScript : public SpellScript
        {
            ...
            void RemoveAliveTarget(std::list<WorldObject*>& targets)
            {
                ...
                SkyMistCore::RandomResizeList(targets, 2);
            }
    ...
    public:
        ...
        bool OnTrigger(Player* player, AreaTriggerEntry const* /*areaTrigger*/)
        {
            ...
            if (instance->GetData(DATA_COLDFLAME_JETS) == NOT_STARTED)
            {
                ...
                traps.sort(SkyMistCore::ObjectDistanceOrderPred(player));
                bool instant = false;
