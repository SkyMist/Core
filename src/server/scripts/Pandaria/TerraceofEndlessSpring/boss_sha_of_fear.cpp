...
public:
    ...
    {
        boss_sha_of_fearAI(Creature* creature) : BossAI(creature, DATA_SHA_OF_FEAR_EVENT), summons(me)
        {
        ...
        void EnterCombat(Unit* /*who*/) OVERRIDE
        {
            ...
            if (instance)
            {
                instance->SetData(DATA_SHA_OF_FEAR_EVENT, IN_PROGRESS);
        ...
        void EnterEvadeMode() OVERRIDE
        {
            ...
            if (instance)
            {
                instance->SetData(DATA_SHA_OF_FEAR_EVENT, FAIL);
        ...
        void JustDied(Unit* /*killer*/) OVERRIDE
        {
            ...
            if (instance)
            {
                instance->SetData(DATA_SHA_OF_FEAR_EVENT, DONE);
                instance->SendEncounterUnit(ENCOUNTER_FRAME_DISENGAGE, me); // Remove
            }
