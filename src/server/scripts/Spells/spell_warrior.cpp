        ...
        class spell_warr_execute_SpellScript : public SpellScript
        {
            ...
            void HandleEffect(SpellEffIndex /*effIndex*/)
            {
                ...
                if (GetHitUnit())
                {
                    ...
                    int32 rageUsed = std::min<int32>(200 - spellInfo->CalcPowerCost(caster, SpellSchoolMask(spellInfo->SchoolMask), caster->GetSpellPowerEntryBySpell(spellInfo)), caster->GetPower(POWER_RAGE));
