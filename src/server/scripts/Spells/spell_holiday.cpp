    ...
    public:
        ...
        class spell_love_is_in_the_air_romantic_picnic_AuraScript : public AuraScript
        {
            ...
            void OnPeriodic(constAuraEffectPtr /*aurEff*/)
            {
                ...
                SkyMistCore::AnyPlayerInObjectRangeCheck checker(target, INTERACTION_DISTANCE*2);
                SkyMistCore::PlayerListSearcher<SkyMistCore::AnyPlayerInObjectRangeCheck> searcher(target, playerList, checker);
