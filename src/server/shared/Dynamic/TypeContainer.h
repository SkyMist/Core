...
{
    public:
        template<class SPECIFIC_TYPE> size_t Count() const { return SkyMistCore::Count(i_elements, (SPECIFIC_TYPE*)NULL); }

        /// inserts a specific object into the container
        template<class SPECIFIC_TYPE> bool insert(SPECIFIC_TYPE *obj)
        {
            SPECIFIC_TYPE* t = SkyMistCore::Insert(i_elements, obj);
            return (t != NULL);
        }
        ...
        //{
        //    SPECIFIC_TYPE* t = SkyMistCore::Remove(i_elements, obj);
        //    return (t != NULL);
        //}
