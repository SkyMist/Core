...
insert  into `realmlist`(`id`,`name`,`address`,`port`,`icon`,`flag`,`timezone`,`allowedSecurityLevel`,`population`,`gamebuild`,`online`) values (1,'Test','127.0.0.1',8085,0,0,1,0,0,18019,1);
